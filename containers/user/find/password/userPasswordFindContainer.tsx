...
import UserPasswordFindComponent from '../../../../components/user/find/password';
...
@inject('userStore')
@observer
class UserPasswordFindContainer extends React.Component<Props> {
...
export default UserPasswordFindContainer;
